...
<body>
        ...
        <!-- Room Start -->
                ...
                <div class="container1">
                    ...
                    <div class="column sign-up">
                        ...
                        <form method="POST" action='usercode.php' onClick="formValidation()" >
                            ...
                            <input type="text"  name="contact" max length="10" pattern="[789][0-9]{10}"required><br><br>
    ...
    var username = document.getElementById('usertname').value;
...
function  contact(contact) {
  var message = document.getElementsByClassName("error-message");
  var numbers = /^[0-9]+$/;
  if ( contact =="" || contact.match(numbers)) {
    text="";
    ...
    text="contact should contain only numbers";
    message[3].innerHTML = text;
    return false;
  }
}
